...
def arguments():
    ...
    * parser 이용하여 프로그램 실행 인자 받기
    ...
    parser.add_argument("--nums_to_generate",
                        ...
                        default=ConstVar.NUM_GENERATION,
    ...
    parser.add_argument("--checkpoint_file",
                        ...
                        default='C:/dragonhyeon/python_directory/movements/45singan/DATA/checkpoint/mountains/iter02000/checkpoint.ckpt',
...
def run_program(args):
    ...
    * 테스트 실행
    ...
    # 모델 모음 불러오기
    Gs = state[ConstVar.KEY_STATE_GS]
    # 각 모델을 해당 디바이스로 이동
    for G in Gs:
        G.to(device)

    # 시그마 모음 불러오기
    sigmas = state[ConstVar.KEY_STATE_SIGMAS]

    # 이미지 피라미드 불러오기
    image_pyramids = state[ConstVar.KEY_STATE_IMAGE_PYRAMIDS]
