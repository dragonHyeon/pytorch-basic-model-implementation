...
def arguments():
    ...
    * parser 이용하여 프로그램 실행 인자 받기
    ...
    parser.add_argument("--train_data_path",
                        ...
                        default=ConstVar.DATA_PATH_TRAIN,
    ...
    parser.add_argument("--decay_iter_num",
                        ...
                        default=ConstVar.DECAY_ITER_NUM,
                        dest='decay_iter_num')
...
def run_program(args):
    ...
    * 학습 실행
    ...
    from DeepLearning.loss import loss_fn_GAN
    from DeepLearning.metric import GAN_loss
    ...
    optimizerGs = []
    optimizerDs = []
    in_channels = image_pyramids[0][ConstVar.KEY_IMGPYR_IMAGE].shape[1]
    num_hidden = 16
